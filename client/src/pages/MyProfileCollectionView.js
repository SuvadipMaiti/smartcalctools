      ...
      <section className="playlist-videos">
        ...
        <div className="box-container">
          {collection.hasManyCalculatorInCollections &&
            collection.hasManyCalculatorInCollections.map(
              (calculatorcollection, i) => (
                <div
                  className="box"
                  key={calculatorcollection?.id ? calculatorcollection?.id : i}
                >
                  <Link
                    to={url.calculatorView(
                      calculatorcollection?.belongsToCalculator?.slug
                    )}
                  >
                  ...
                  {parseInt(collection?.belongsToUser?.id) === parseInt(id) && (
                    <Link
                      to={url.calculatorEdittoCollection(
                        collection?.belongsToUser?.id,
                        calculatorcollection?.id
                      )}
                      className="btn"
                    >
                      Edit
...
export default MyProfileCollectionView;
